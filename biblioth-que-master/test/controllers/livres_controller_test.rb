...
class LivresControllerTest < ActionController::TestCase
  ...
  test "should create livre" do
    assert_difference('Livre.count') do
      post :create, livre: { auteur: @livre.auteur, description: @livre.description, prix: @livre.prix, titre: @livre.titre, url: @livre.url }
    end
  ...
  test "should update livre" do
    patch :update, id: @livre, livre: { auteur: @livre.auteur, description: @livre.description, prix: @livre.prix, titre: @livre.titre, url: @livre.url }
    assert_redirected_to livre_path(assigns(:livre))
  end
